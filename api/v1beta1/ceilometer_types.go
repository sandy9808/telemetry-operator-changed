...
const (
	...
	CeilometerCentralContainerImage = "devopsartifact.jio.com/docker-virtual-all/podified-antelope-centos9/openstack-ceilometer-central:current-podified"
	// CeilometerNotificationContainerImage - default fall-back image for Ceilometer Notification
	CeilometerNotificationContainerImage = "devopsartifact.jio.com/docker-virtual-all/podified-antelope-centos9/openstack-ceilometer-notification:current-podified"
	// CeilometerSgCoreContainerImage - default fall-back image for Ceilometer SgCore
	CeilometerSgCoreContainerImage = "devopsartifact.jio.com/docker-virtual-all/openstack-k8s-operators/sg-core:v6.0.0"
	// CeilometerComputeContainerImage - default fall-back image for Ceilometer Compute
	CeilometerComputeContainerImage = "devopsartifact.jio.com/docker-virtual-all/podified-antelope-centos9/openstack-ceilometer-compute:current-podified"
	// CeilometerIpmiContainerImage - default fall-back image for Ceilometer Ipmi
	CeilometerIpmiContainerImage = "devopsartifact.jio.com/docker-virtual-all/podified-antelope-centos9/openstack-ceilometer-ipmi:current-podified"
	// CeilometerProxyContainerImage - default fall-back image for proxy container
	// CeilometerProxyContainerImage = "devopsartifact.jio.com/docker-virtual-all/ubi9/httpd-24:latest"
	CeilometerProxyContainerImage = "devopsartifact.jio.com/docker-virtual-all/podified-antelope-centos9/openstack-aodh-api:current-podified"
	// KubeStateMetricsImage - default fall-back image for KSM
	KubeStateMetricsImage = "devopsartifact.jio.com/docker-virtual-all/kube-state-metrics/kube-state-metrics:v2.10.0"
)
