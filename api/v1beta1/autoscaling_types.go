...
const (
	...
	AodhAPIContainerImage = "devopsartifact.jio.com/docker-virtual-all/podified-antelope-centos9/openstack-aodh-api:current-podified"
	// AodhEvaluatorContainerImage - default fall-back image for Aodh Evaluator
	AodhEvaluatorContainerImage = "devopsartifact.jio.com/docker-virtual-all/podified-antelope-centos9/openstack-aodh-evaluator:current-podified"
	// AodhNotifierContainerImage - default fall-back image for Aodh Notifier
	AodhNotifierContainerImage = "devopsartifact.jio.com/docker-virtual-all/podified-antelope-centos9/openstack-aodh-notifier:current-podified"
	// AodhListenerContainerImage - default fall-back image for Aodh Listener
	AodhListenerContainerImage = "devopsartifact.jio.com/docker-virtual-all/podified-antelope-centos9/openstack-aodh-listener:current-podified"
	// DbSyncHash hash
	DbSyncHash = "dbsync"
)
